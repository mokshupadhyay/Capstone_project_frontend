...
//             <div className="flex flex-col md:flex-row bg-white rounded-xl shadow-md hover:shadow-lg transition-shadow duration-300 overflow-hidden cursor-pointer w-full">
//                 <div className="relative w-full md:w-1/7 h-64 md:h-auto">
//                     <Image
//                         src={pdf}
//                         alt={project.title}
//                         fill
