...
//     description: string;
//     created_at: string;
//     hasSubmittedPhase1: boolean; // Add phase-specific flags
//     hasSubmittedPhase2: boolean;
//     phase1Submission?: Submission | null;
//     phase2Submission?: Submission | null;
//     files: File[] | null;
//     phase1DeadlinePassed: boolean; // Add deadline flags
...
//                         phase1DeadlinePassed: p.phase1DeadlinePassed,
//                         phase2DeadlinePassed: p.phase2DeadlinePassed
//                     });
//                 });
...
//     // Update date formatting in render
//     const getLatestSubmissionDate = (project: Project) => {
//         const dates = [];
//         if (project.phase1Submission) dates.push(project.phase1Submission.submitted_at);
//         if (project.phase2Submission) dates.push(project.phase2Submission.submitted_at);

//         return dates.length > 0
//             ? formatDate(new Date(Math.max(...dates.map(d => new Date(d).getTime()))).toString())
//             : null;
//     };
...
//                             const submittedDate = project.submission?.submitted_at
//                                 ? formatDate(project.submission.submitted_at)
//                                 : null;
...
//                                 >
//                                     <div className="border-l-4 border-green-500 pl-4 py-3 bg-green-50 flex items-center">
//                                         <CheckCircle2 className="text-green-600 mr-2" size={18} />
//                                         <span className="font-medium text-green-800">Completed</span>
//                                         {submittedDate && (
//                                             <span className="ml-auto mr-6 text-sm text-green-700 font-medium">
...
//                                 className="border border-gray-200 rounded-xl shadow-sm hover:shadow-md transition-all duration-300 bg-white overflow-hidden"
//                             >
//                                 <div className="border-l-4 border-yellow-500 pl-4 py-3 bg-yellow-50 flex items-center">
//                                     <Clock className="text-yellow-600 mr-2" size={18} />
//                                     <span className="font-medium text-yellow-800">Pending</span>
//                                     <button className="ml-auto bg-indigo-600 hover:bg-indigo-700 text-white py-1 px-4 text-sm font-medium rounded-md transition-colors mr-6">
//                                         Submit Now
//                                     </button>
//                                 </div>
