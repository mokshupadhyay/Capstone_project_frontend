...
import { FileText, FolderOpen, UploadCloud, CheckCircle2, Clock4 } from 'lucide-react';
    ...
    return (
        <div className="p-6">
            <div className="mb-8">
                ...
                <p className="mt-2 text-gray-600">Monitor and manage all capstone projects</p>
            </div>
                    ...
                    <div className="grid grid-cols-1 gap-6">
                        {activeProjects.map((project) => (
                            <div key={project.id} className="bg-white border rounded-xl shadow-sm hover:shadow-md transition-all duration-300">
                                <ProjectCard project={project} role="coordinator" />
                            </div>
                        ))}
                    </div>
                </div>
