...
//     // This is a simplified version that would need to be expanded based on
//     // the actual API endpoints for different roles
//     useEffect(() => {
//         const fetchProjects = async () => {
//             try {
//                 setIsLoading(true);
//                 // Assume we're using the student projects endpoint for now
//                 // In a real implementation, we'd have specific endpoints for each role
...
//         <div>
//             <div className="mb-8">
//                 <h2 className="text-2xl font-semibold mb-2">{roleDisplay()} Dashboard</h2>
//                 <p className="text-gray-600">
//                     Access and review capstone projects based on your permissions.
//                 </p>
//             </div>
...
//                     <p className="text-gray-600">
//                         There are currently no projects available for your role.
//                     </p>
//                 </div>
//             ) : (
...
//                 <h3 className="text-xl font-semibold mb-4">Role Information</h3>
//                 <div className="bg-white p-4 rounded-md shadow-sm">
//                     <p className="font-medium mb-2">Your Role: {roleDisplay()}</p>
//                     <p className="text-gray-600 mb-4">
//                         {user?.role === 'academic_team' && 'You can view and evaluate capstone projects.'}
//                         {user?.role === 'evaluator' && 'You can review and grade student submissions.'}
//                         {user?.role === 'manager' && 'You have oversight of the capstone program.'}
//                         {user?.role === 'coordinator' && 'You can coordinate between students and teachers.'}
//                     </p>
...
//                             <li>Download project materials</li>
